...
**Главный экран** — маршруты как табло отправлений: день, время события и время,
когда выходить. Сегодняшняя строка подсвечена.

![Табло с маршрутами](docs/screenshots/board.png)
